...
//  $multiImagesCount = count($_FILES["multimg"]["name"]);
//  $multiImagesArray = [];
//  for ($i = 0; $i < $multiImagesCount; $i++) {
//    $imageFileName = $_FILES["multimg"]["name"][$i];
//    $imageTempName = $_FILES["multimg"]["tmp_name"][$i];
...
//  $multiImageArray = json_encode($multiImagesArray);
  ...
  $qry = "INSERT INTO package(PackageName,Image_one,Image_two,Package_price)VALUES('$packname','$new_imageOneFileName','$new_imageTwoFileName','$packPrice')";
  $con->query($qry);
...
<head>
  ...
  <title>Malcom Lismore Dashboard</title>
  <meta content="width=device-width, initial-scale=1.0, shrink-to-fit=no" name="viewport" />
  <link rel="icon" href="../assets/img/Lismore1.png" type="image/x-icon" />
          ...
          <div class="card p-5">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group mb-3">
                ...
                <input type="file" name="multimg" id="" class="form-control" accept=".jpg,.jpeg,.png" Multiple>
              </div>
