...
<body>
      ...
      <div class="slick-slider slick-style-1" data-arrows="true" data-autoplay="true" data-loop="true" data-dots="true" data-swipe="true" data-xs-swipe="true" data-sm-swipe="false" data-items="1" data-sm-items="3" data-md-items="3" data-lg-items="3" data-center-mode="true" data-lightgallery="group-slick">
        <div class="item">
          <div class="slick-slide-inner">
            <div class="slick-slide-caption"><a class="thumb-ann thumb-mixed_large" href="images/Photo1.jpg" data-lightgallery="item"><img class="thumb-ann__image" src="images/Photo1.jpg" alt="" width="961" height="664" />
                <div class="thumb-ann__caption">
                  <p class="thumb-ann__title heading-3">Image #1</p>
                  <p class="thumb-ann__text">With the experience of more than 10 years, I am glad to offer you a wide variety of photography services at affordable prices.</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="item">
          <div class="slick-slide-inner">
            <div class="slick-slide-caption"><a class="thumb-ann thumb-mixed_large" href="images/Photo2.jpg" data-lightgallery="item"><img class="thumb-ann__image" src="images/Photo2.jpg" alt="" width="961" height="664" />
                <div class="thumb-ann__caption">
        ...
        <div class="item">
          <div class="slick-slide-inner">
            <div class="slick-slide-caption"><a class="thumb-ann thumb-mixed_large" href="images/Photo3.jpg" data-lightgallery="item"><img class="thumb-ann__image" src="images/Photo3.jpg" alt="" width="961" height="664" />
                <div class="thumb-ann__caption">
        ...
        <div class="item">
          <div class="slick-slide-inner">
            <div class="slick-slide-caption"><a class="thumb-ann thumb-mixed_large" href="images/Photo5.jpg" data-lightgallery="item"><img class="thumb-ann__image" src="images/Photo5.jpg" alt="" width="961" height="664" />
                <div class="thumb-ann__caption">
    ...
    <div class="shell">
      <div class="range range-50 range-sm-center range-md-left range-md-middle range-md-reverse">
        <div class="cell-sm-6 wow fadeInRightSmall">
          <div class="thumb-line"><img src="images/aboutme.jpeg" alt="" width="531" height="640" />
          </div>
        </div>
        <div class="cell-sm-6">
  ...
  <!-- Awards-->
  <section class="section parallax-container bg-image-dark" data-parallax-img="images/gradiant.jpg">
        ...
        <div class="shell">
          <div class="range range-50 range-lg-bottom">
            <div class="cell-xs-6 cell-md-3 wow fadeIn">
              <!-- Box award-->
              <article class="box-award"><img class="box-award__image" src="images/p20.jpg" alt="" width="134" height="98" />
            ...
            <div class="cell-xs-6 cell-md-3 wow fadeIn" data-wow-delay=".1s">
              <!-- Box award-->
              <article class="box-award"><img class="box-award__image" src="images/nature.png" alt="" width="115" height="117" />
            ...
            <div class="cell-xs-6 cell-md-3 wow fadeIn" data-wow-delay=".2s">
              <!-- Box award-->
              <article class="box-award"><img class="box-award__image" src="images/p22.jpg" alt="" width="116" height="103" />
            ...
            <div class="cell-xs-6 cell-md-3 wow fadeIn" data-wow-delay=".3s">
              <!-- Box award-->
              <article class="box-award"><img class="box-award__image" src="images/p17.jpg" alt="" width="131" height="96" />
      ...
      <div class="range range-30">
        <div class="cell-sm-6 cell-md-4 wow fadeInLeftSmall">
          ...
          <article class="post-boxed">
            <ul class="post-boxed__meta">
              <li>
                <time datetime="2019">Jul 20, 2024</time>
              </li>
            ...
            <div class="post-boxed__aside">
              <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                ...
                <div class="unit__body">
                  <h6 class="text-uppercase">by Malcom Lismore</h6>
                </div>
              </div>
            </div>
          </article>
        ...
        <div class="cell-sm-6 cell-md-4 wow fadeInLeftSmall" data-wow-delay=".15s">
          ...
          <article class="post-boxed">
            <ul class="post-boxed__meta">
              <li>
                <time datetime="2024">Jul 15, 2024</time>
              </li>
              <li><a href="#">3 comments</a></li>
            </ul>
            <div class="post-boxed__main">
      ...
      <div class="range range-sm-center">
        <div class="cell-sm-10 cell-md-8 cell-lg-6">
          <!-- Brand--><a class="brand" href="index.html">
            <div class="brand__name"><img src="images/Lismorewhite.png" alt="" width="237" height="35" />
            </div>
          </a>
          <!-- RD Mailform-->
          ...
          <ul class="list-inline list-inline-md rd-navbar-corporate-list-social">
            ...
            <li><a class="icon icon-sm icon-circle icon-circle-md icon-bg-white fa fa-pinterest" href="#"></a></li>
          </ul>
          <!-- Rights-->
